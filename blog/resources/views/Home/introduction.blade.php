					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/{{ $goods_data->goods_pic }}"><img src="/images/{{ $goods_data->goods_pic }}" alt="细节展示放大镜特效" rel="/images/{{ $goods_data->goods_pic }}" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="/images/{{ $goods_data->goods_pic }}" mid="/images/{{ $goods_data->goods_pic }}" big="/images/{{ $goods_data->goods_pic }}"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">{{ $goods_data->goods_price }}</b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">{{ $goods_info_data->goods_rel_price }}</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">月销量</span><span class="tm-count">{{ $goods_info_data->month_sales }}</span></div>
								</li>
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">{{ $goods_data->goods_sales }}</span></div>
								</li>
								<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
									<div class="tm-indcon"><span class="tm-label">累计评价</span><span class="tm-count">{{ $goods_info_data->goods_comment_num  or '0'}}</span></div>
								</li>
							</ul>
							<div class="clear"></div>
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<ul>
															...
															<li class="sku-line">{{ $goods_info_data->style }}<i></i></li>
													...
													<div class="theme-options">
														...
														<ul>
															<li class="sku-line selected">{{ $goods_info_data->style_detail }}<i></i></li>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="/home/shopcart/{{ $goods_data->id }}"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
				...
				<div class="match">
					...
					<div class="match-comment">
						<ul class="like_list">
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="/images/{{ $goods_info_data->info_pic }}"></a>
								</div> <a class="txt" target="_blank" href="#">{{ $goods_data->goods_name }}</a>
								<div class="info-box"> <span class="info-box-price">¥ {{ $goods_data->goods_price }}</span> <span class="info-original-price">￥ {{ $goods_info_data->goods_rel_price }}</span> </div>
							</li>
