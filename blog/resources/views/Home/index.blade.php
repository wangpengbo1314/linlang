										...
										<ul class="category-list" id="js_climit_li">
											...
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													...
													<h3 class="category-name b-category-name"><i><img src="images/cake.png"></i><a class="ml-22" title="{{ $v->cname  }}" href="#">{{ $v->cname  }}</a></h3>
													<em>&gt;</em></div>
															...
															<div class="menu-srot">
																<div class="sort-side">
																	<dl class="dl-sort">
																		...
																		<dt><span title="{{ $vv->cname }}"><a href="#">{{ $vv->cname }}</a></span></dt>
																		
																		
																		@foreach($vv['sub'] as $kkk=>$vvv)
																		<dd><a title="{{ $vvv->cname }}" href="/home/info/{{ $vvv->id }}"><span>{{ $vvv->cname }}</span></a></dd>
																		@endforeach
																		@endforeach
																	</dl>					
