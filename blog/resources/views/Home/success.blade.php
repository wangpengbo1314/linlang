...
<div class="take-delivery">
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
       <li>付款金额<em>¥{{$table}}</em></li>
       <div class="user-info">
         <p>收货人：{{$address->name}}</p>
         <p>联系电话：{{$address->phone}}</p>
         <p>收货地址：{{$address->cmbProvince}}省 {{$address->cmbCity}} {{$address->cmbArea}} {{$address->cmbAddress}}</p>
       </div>
     ...
     <div class="option">
       <span class="info">您可以</span>
        <a href="/home/pay/orders" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
        <a href="/home/pay/ordersinfo" class="J_MakePoint">查看<span>订单详情</span></a>
     </div>
    </div>
  </div>
</div>
