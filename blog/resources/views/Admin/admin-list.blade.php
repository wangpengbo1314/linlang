...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','/admin/user/index','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>{{ $counts }}</strong> 条</span> </div>
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>
					@if($v->adminRole == 0)
					超级管理员
					@elseif($v->adminRole == 1)
					一般管理员
					@elseif($v->adminRole == 2)
					普通管理员
					@elseif($v->adminRole == 3)
					普通用户
					@endif
				</td>
				<td>{{ $v->created_at }}</td>
				...
				<td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="/admin/user/update/{{ $v->id }}" onclick="admin_edit1('管理员编辑','admin-add.html','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="/admin/user/delete/{{ $v->id }}" onclick="admin_del1(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			<!-- <tr class="text-c">
