    ...
    <form class="form form-horizontal" action="/admin/login" method="post">
     ...
     <!--  <div class="row cl">
      ...
      function change(){
         ...
         img.src='./index.php?c=Code&a=index&rand='+Math.random();  
      }

      </script>

        <div class="formControls col-xs-8 col-xs-offset-3">
          <input class="input-text size-L" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="change()"" value="" style="width:150px;" name="code">
