...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 收藏列表 <span class="c-gray en">&gt;</span> 收藏中心 <span class="c-gray en">&gt;</span> 收藏管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
				...
				<tr class="text-c">
					...
					<td>
						<form action="/admin/goods/{{ $v->id }}" method="post" style="display: inline-block; margin-top: 10px;">
							...
							<a href="/admin/info/index/{{ $v->id }}" class="btn btn-success">列表</a>
